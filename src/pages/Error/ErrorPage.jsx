...
const ErrorPage = () => {
  ...
  return (
    <section className=" min-h-screen bg-neutral-700">
      <div className="container flex justify-center items-center px-6 py-12 mx-auto min-h-screen">
        <div className="flex flex-col items-center justify-center max-w-sm mx-auto text-white  bg-lime-800 w-1/2 h-[400px] shadow-lg shadow-white rounded-xl">
          ...
          <p className="mt-4 text-gray-300 ">Here are some helpful links:</p>
